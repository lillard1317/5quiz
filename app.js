...
function MenuScreen({ allQuestions, onStart }) {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"linear-gradient(160deg,#1a1a2e,#16213e,#0f3460)", fontFamily:"-apple-system,Hiragino Sans,sans-serif", padding:"18vh 20px 100px" }}>
